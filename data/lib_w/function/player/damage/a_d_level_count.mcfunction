scoreboard players operation #attack store = @e[limit=1,tag=attacker] attack_level
...
scoreboard players operation #damage damage *= @e[limit=1,tag=attacker] power
execute unless entity @e[tag=attacker] run scoreboard players operation #damage damage *= 100 const
scoreboard players operation #damage damage /= 100 const
